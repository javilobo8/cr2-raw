...
test('extract preview image from _MG_4122.CR2', async () => {

  const cr2Path = path.resolve(__dirname, 'res', '_MG_4122.CR2');
  const raw = await cr2Raw(cr2Path);
...
test('extract thumbnail image from _MG_4122.CR2', async () => {
...
test('fetch image width from _MG_4122.CR2', async () => {
...
test('fetch image height from _MG_4122.CR2', async () => {
...
test('fetch date taken from _MG_4122.CR2', async () => {
...
test('extract preview image from _MG_7688.CR2', async () => {
...
test('extract thumbnail image from _MG_7688.CR2', async () => {
...
test('fetch image width from _MG_7688.CR2', async () => {
...
test('fetch image height from _MG_7688.CR2', async () => {
...
test('fetch date taken from _MG_7688.CR2', async () => {
...
test('extract preview image from _MG_8367.CR2', async () => {
...
test('extract thumbnail image from _MG_8367.CR2', async () => {
...
test('fetch image width from _MG_8367.CR2', async () => {
...
test('fetch image height from _MG_8367.CR2', async () => {
...
test('fetch date taken from _MG_8367.CR2', async () => {
...
test('extract preview image from notraw.jpg', async () => {
...
test('extract thumbnail image from notraw.jpg', async () => {
